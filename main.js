function findTopic() {
    ...
    if(userinput == "Freedom 7"){
        window.location.href = "Topic-1.html" //sends the user to "topic 1" if they type in the correct input 
    }else if(userinput == "Liberty Bell 7"){
        window.location.href = "Topic-2.html"
    }else if(userinput == "Friendship 7"){
        window.location.href = "Topic-3.html"
    }else if(userinput == "Aurora 7"){
        window.location.href = "Topic-4.html"
    }else if(userinput == "Sigma 7"){
        window.location.href = "Topic-5.html"
    } else if(userinput == "Faith 7"){
        window.location.href = "Topic-6.html"
    }
}
